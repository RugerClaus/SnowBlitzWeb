...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="assets/linux.ico" type="image/x-icon">
    ...
    <body>
        ...
        <section class="home_wrapper" id="home">
            ...
            <div class="article_section_wrapper">
                    <div class="home_display">
                        <h3>Bug Detectives:</h3>
                        <ul>
                            <li><img src="assets/junderson.png" alt="junderson pfp">junderson</li>
                        </ul>
                    </div>
                    <div class="home_display">
                        <h3>Artists:</h3>
                        <ul>
                            <li><img src="assets/rockinrollinqueen.png" alt="rockinrollinqueen pfp">rockinrollinqueen</li>
                        </ul>
                    </div>
                    <div class="home_display">
                        <h3>Contributors:</h3>
                        <ul>
                            <li><img src="assets/rugerclaus.png" alt="rugerclaus pfp">rugerclaus</li>
                        </ul>
                    </div>
            </div>
        </section>
        ...
        <section class="about_wrapper" id="about">
            ...
            <p>If you'd like to contribute to the game, you can visit the GitHub project here: <a href="https://github.com/rugerclaus/SnowBlitzProduction">Snow Blitz Production GitHub Repository</a></p>
